...
if (!window.GlobalUtilities) window.GlobalUtilities = {
    ...
    popup_menu: function popup_menu(container, content, params) {
        ...
        var elems = GlobalUtilities.create_nested_elements([
            {
                ...
                Childs: [
                    ...
                    {
                        Type: "div", Class: "rv-border-radius-half SoftBackgroundColor SoftBorder", Name: "content",
        ...
        var _reposition = function () {
            ...
            elems["arrow"].setAttribute("style", "width:0.8rem; height:0.8rem;" +
                GlobalUtilities.transform_rotate(45) + arrowDivStyle);

            contentDiv.setAttribute("style", "padding:0.5rem;" + contentDivStyle);
        ...
        var retVal = {
            ...
            Show: function (done) { jQuery(elems["container"]).fadeIn(0, function () { _reposition(); if (done) done(); }); },
    ...
    scroll_into_view: function (_elem, params) {
        ...
        jQuery('html, body').animate({
            scrollTop: jQuery(_elem).offset().top - (params.Offset === 0 ? 0 : params.Offset || 100)
        }, 'slow', params.Done);
        /*
        _elem.scrollIntoView();
        if (_elem.offsetTop - window.pageYOffset < 100) {
        ...
        var elems = GlobalUtilities.create_nested_elements([
            {
                ...
                Style: "margin-top:1rem; padding:0.3rem; padding-top:1rem; position:relative;",
                Childs: [
                    {
                        Type: "div",
                        Style: "position:absolute; left:0rem; right:0rem; top:-1rem;" +
                            (params.Title || params.Button ? "" : "display:none;"),
                        Childs: [
                            {
                                Type: "div", Class: "small-12 medium-12 large-12 row", Style: "margin:0rem; padding:0rem 0.6rem;",
                                Childs: [
                                    {
                                        Type: "div", Class: "small-9 medium-9 large-9",
                                        Childs: [
                                            {
                                                Type: "div", Class: "rv-border-radius-quarter SoftBorder WarmBackgroundColor",
                                                Style: "display:" + (params.Title ? "inline-block" : "none") + ";" +
                                                    "padding:0.2rem 0.5rem; color:white; text-align:center;",
                                                Childs: [{ Type: "text", TextValue: params.Title }]
                                            }
                                        ]
                                    },
                                    {
                                        Type: "div", Class: "small-3 medium-3 large-3 RevTextAlign",
                                        Childs: [
                                            {
                                                Type: "div", Class: "rv-circle SoftBorder", Name: "button",
                                                Style: "display:" + (params.Button ? "inline-block" : "none") + ";" +
                                                    "cursor:pointer; width:2rem; height:2rem; background-color:white;" +
                                                    "font-weight:bold; padding:1px; text-align:center; margin-top:-0.2rem;"
                                            }
                                        ]
                                    }
                                ]
        ...
        var elems = GlobalUtilities.create_nested_elements([
            {
                ...
                Childs: [
                    {
                        Type: "div", Name: "exit", Class: "RevTextAlign",
    ...
    get_text_begining: function (text, length, postfix) {
        ...
        GlobalUtilities.append_markup_text(_testDiv, text, { RichText: true });
    ...
    append_autosuggest: function (_div, params) {
        ...
        var elems = GlobalUtilities.create_nested_elements([
            {
                Type: "input", Class: params.InputClass || "rv-input",
                InnerTitle: params.InnerTitle, Style: params.InputStyle,
    ...
    _append_rich_text_editor: function (_div, params, done) {
        ...
        var _get_editor = function (data) {
            return CKEDITOR.appendTo(_div, {
                ...
                language: 'fa', extraPlugins: 'RVCodeHighlighter,RVMediaSelect,colorbutton,colordialog,RVTag,RVUploader,autogrow,pastefromexcel',
        ...
        var _onInstanceReady = function () {
            ...
            if (!(params.EnableMediaSelect === false)) {
    ...
    append_checkbox: function (element, params) {
        ...
        var img = GlobalUtilities.create_nested_elements([{
            Type: "img", Name: "image",
            Style: params.Style || ("width:" + width + "; height:" + height + "; cursor:pointer;"),
    ...
    _append_typed_input: function (element, params, options) {
        ...
        var elems = GlobalUtilities.create_nested_elements([
            {
                Type: "input", Class: "rv-input", Name: "_input", Style: params.Style || "", InnerTitle: params.InnerTitle,
    ...
    set_inner_title: function (input, title) {
        ...
        var __set_style = function (_input) {
            _input.style.color = "#cdcdcd";
            _input.style.fontWeight = "bold";
        }

        var __remove_style = function (_input) {
            _input.style.color = "";
            _input.style.fontWeight = "";
        }
    ...
    append_calendar: function (element, params, done) {
        ...
        GlobalUtilities.load_calendar(function () {
            ...
            var elems = GlobalUtilities.create_nested_elements([
                {
                    Type: "div", Class: "rv-border-radius-quarter WarmBorder",
                    Style: "background-color:white; padding:" + (params.Padding || "0.3rem") + ";" +
